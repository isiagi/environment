      ...
      <ScrollView flex={1}>
        ...
        <View paddingHorizontal={20}>
          ...
          <View marginTop={25} flexDirection="row">
            ...
            <View>
              <Text lineHeight={24}>SAT, Mar 08, 7:00 AM</Text>
              <Text lineHeight={24}>Physical</Text>
              <Text lineHeight={24}>In Person</Text>
            </View>
          </View>
          ...
          <View marginTop={25}>
            ...
            <Button onPress={() => setIsSheetOpen(true)} borderRadius={20}>
